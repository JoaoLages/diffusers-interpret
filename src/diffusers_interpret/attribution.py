...
def gradient_x_inputs_attribution(
    ...
    # equivalent to `grad = torch.autograd.grad(tuple_of_pred_logits, input_embeds)[0]`
    input_embeds.retain_grad()
    torch.autograd.backward(tuple_of_pred_logits)

    # Grad X Input
    grad_x_input = input_embeds.grad * input_embeds
